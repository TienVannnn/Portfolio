<template>
  <section class="relative w-full" data-aos="zoom-in-up" id="overview">
    ...
    >
      ...
      >
        <div class="lg:py-6">
          ...
          <p
            class="text-gray-300 font-bold pt-8 text-center lg:text-left mx-auto max-w-xl"
          >
            🙌 Hello,
            <span ref="typewriter2"> </span>
          </p>
          <div
