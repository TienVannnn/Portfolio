<template>
  ...
  >
    <a href="#overview" class="text-white text-3xl font-bold uppercase"
      >OVERVIEW</a
    >
    ...
    >
      ...
      >
        <li v-for="(item, index) in menu" :key="index">
          <a
            :href="item.href"
            class="block text-white transition hover:text-primary ease-linear text-2xl md:text-lg uppercase"
